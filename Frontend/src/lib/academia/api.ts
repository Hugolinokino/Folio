...
export const academiaApi = {
  ...
  createSource: (
    ...
    year: number | null,
    annotation: string,
  ) => invoke<SourceDto>('create_source', { projectId, type, citationKey, title, author, year, annotation }),
  ...
  importSource: (
    ...
    invoke<SourceDto>('import_source', {
      projectId, sourcePath, type, citationKey, title, author, year, annotation, content,
    }),
