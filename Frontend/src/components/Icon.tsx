...
export type IconName =
  | 'arrow-left' | 'arrow-right' | 'arrow-up-right' | 'plus' | 'search' | 'filter'
  | 'check' | 'close' | 'book' | 'folder' | 'doc' | 'note' | 'globe' | 'scales'
  | 'sparkle' | 'quote' | 'pen' | 'download' | 'menu-dots' | 'tag' | 'sort'
  | 'columns' | 'list' | 'grid' | 'time' | 'pin' | 'link' | 'export' | 'mic'
  | 'flag' | 'star' | 'archive' | 'home' | 'chevron-down' | 'edit' | 'upload'
  | 'chat' | 'sun' | 'moon' | 'graph' | 'mail' | 'lock' | 'eye';
